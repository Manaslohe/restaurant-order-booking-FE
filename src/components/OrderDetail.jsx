...
function OrderDetail({ order, onClose, onDeliveryUpdate }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-6 z-50">
      <div className="bg-white rounded-2xl w-full max-w-5xl shadow-2xl overflow-hidden transition-all duration-300">
        {/* Header */}
        <div className="p-6 bg-gradient-to-br from-orange-100 to-white border-b border-gray-200 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-2xl font-semibold text-gray-800">Order #{order._id.slice(-6)}</h2>
        ...
        <div className="p-6 grid grid-cols-3 gap-6">
          ...
          <section className="bg-gray-50 rounded-xl p-5 shadow-sm h-full">
          ...
          <section className="space-y-6">
            {order.remainingThalis > 0 ? (
              <div className="bg-orange-50 rounded-xl p-5 shadow-sm">
                <h3 className="text-lg font-semibold text-gray-800 mb-4">Record New Delivery</h3>
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        className="w-12 h-12 bg-gray-100 rounded-full text-xl font-medium hover:bg-gray-200 disabled:opacity-50 transition-colors duration-200 touch:w-14 touch:h-14"
                      >-</button>
                      <input
                        type="number"
                        min="1"
                        ...
                        className="flex-1 p-3 border border-gray-200 rounded-lg text-center text-lg font-medium focus:outline-none focus:ring-2 focus:ring-orange-300"
                      />
                      <button
                        type="button"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full p-3 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-orange-300 touch:p-4"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full p-3 border border-gray-200 rounded-lg text-sm resize-none h-20 focus:outline-none focus:ring-2 focus:ring-orange-300 touch:p-4"
                    />
                  </div>
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="w-full py-3 bg-orange-500 text-white rounded-lg text-lg font-medium
                             hover:bg-orange-600 transition-all duration-200 disabled:opacity-50 touch:py-4"
                  >
              ...
              <div className="bg-green-50 rounded-xl p-5 shadow-sm text-center h-full flex items-center justify-center">
                <div>
                  <p className="text-green-800 text-lg font-medium">Delivery Complete!</p>
                  <p className="text-sm text-green-600 mt-1">All thalis have been delivered</p>
                </div>
              </div>
            )}
          </section>
